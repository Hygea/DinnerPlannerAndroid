...
public class Prepareadapter extends ArrayAdapter<RowItem> {
 
    Context context;
 
    public Prepareadapter(Context context, int resourceId,
            List<RowItem> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_prepare, null);
